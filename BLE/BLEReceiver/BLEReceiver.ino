...
// BLE Service
static BLEUUID DHT11ServiceUUID("91bad492-b950-4226-aa2b-4ede9fa42f59");
...
bool connectToServer(BLEAddress pAddress) {
  ...
  BLERemoteService* pRemoteService = pClient->getService(DHT11ServiceUUID);
  if (pRemoteService == nullptr) {
    Serial.print("Failed to find our service UUID: ");
    Serial.println(DHT11ServiceUUID.toString().c_str());
    return (false);
  }
